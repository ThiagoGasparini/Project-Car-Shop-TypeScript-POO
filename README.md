...
<details>
  ...
  Para este projeto, foi aplicado os princípios de Programação Orientada a Objetos (`POO`) para a construção de uma API com `CRUD` para gerenciar uma concessionária de veículos. Foi utilizado o banco de dados `MongoDB` através do framework do `Mongoose`.
...
### 03 - Crie a rota /cars/:id onde seja possível atualizar um carro por ID
...
### 04 - Crie a rota /motorcycles onde seja possível cadastrar uma moto
...
### 05 - Crie a rota /motorcycles onde seja possível listar motos
